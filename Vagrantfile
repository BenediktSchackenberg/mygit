...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "schackenberg-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/victorvox"
  #   chef.validation_client_name = "victorvox-validator"
  #   chef.validation_key_path = ".chef/victorvox-validator.pem"
  # end
end
